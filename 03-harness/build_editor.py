...
<h2>The story, in one paragraph</h2>
<p>The Authority promised its lenders that every year it would hold a quarter more than it owes
them. Its own consultant's forecast meets that promise, and the bond documents print a single
figure showing it met. Separate that figure into what it is made of and about
<strong>three dollars in every ten come from two decisions the Authority makes itself</strong>,
each year, and can stop making: money it chooses to designate into the pledge, and a reserve it
chooses to top up. On its own earnings the airport falls short of the promise in every one of the
six forecast years. Separately, the money it designates has not been what the public record
assumed: from 2020 through 2023 it was federal pandemic aid, in 2024 it was nothing at all, and
the forecast replaces it with casino money the Authority has not designated since 2019 and which
the airlines have voted to supply only through 2028. The forecast runs to 2030. The bonds run
to 2056.</p>
